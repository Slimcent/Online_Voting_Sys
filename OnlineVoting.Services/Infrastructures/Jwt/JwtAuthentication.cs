...
namespace OnlineVoting.Services.Infrastructures.Jwt
{
    public class JwtAuthentication
    {
        ...
        public async Task<JwtToken> GenerateJwtToken(User user)
        {
            ...
            List<System.Security.Claims.Claim> userClaims = await GetRoleClaims(user);
            ...
            var claims = new List<System.Security.Claims.Claim>
            {
                ...
                new System.Security.Claims.Claim(_options.ClaimsIdentity.UserIdClaimType, user.Id.ToString()),
                new System.Security.Claims.Claim(_options.ClaimsIdentity.UserNameClaimType, user.UserName),
            };
        ...
        public async Task<List<System.Security.Claims.Claim>> GetRoleClaims(User user)
        {
